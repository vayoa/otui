...
def draw_rectangles(
    ...
    if background is None:
        ...
        canvas = background.resize(canvas_size, Image.Resampling.LANCZOS)
    ...
    for image, location, bubble_list in zip(
        ...
        if bubble_list is not None:
            ...
            for bubble_i, bubble in enumerate(bubble_list):
                ...
                bubble_text_width = draw.textlength(bubble_text, font=bubble_font)
                bubble_text_height = bubble_font_size * bubble_text.count("\n")
